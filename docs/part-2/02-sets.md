...
* - com_tmap (r,com_type,c)
  - 
  - Mapping of commodities to the main commodity types (see **com_type** in {numref}`sets-with-fixed-elements`); \[set of triplets {**r,com_type,c**} such that commodity c has type com_type\];
* - com_ts (r,c,s)
  - 
