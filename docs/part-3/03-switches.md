...
| ECB       | <br>Option to use the Economic Choice Behavior extension (logit market sharing mechanism). To activate this extension, the following control switch needs to be provided in the \<Case\>.run file, as follows:</br> <br>\$SET ECB YES</br> <br>See related user note for more information on the use of this extension.</br>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
